...
export const translations: Record<AppLanguage, TranslationTree> = {
  en: {
    ...
    projects: {
      ...
      colorSheetTitle: 'Choose a payday color',
      colorSheetDescription: 'Pick the color used for this project payday in the calendar.',
      red: 'Red',
      orange: 'Orange',
      green: 'Green',
      teal: 'Teal',
  ...
  es: {
    ...
    projects: {
      ...
      colorSheetTitle: 'Elige un color para el día de paga',
      colorSheetDescription: 'Selecciona el color que se usará para el día de paga de este proyecto en el calendario.',
      red: 'Rojo',
      orange: 'Naranja',
      green: 'Verde',
      teal: 'Turquesa',
